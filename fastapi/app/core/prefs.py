...
No accounts and no database: each browser keeps its own theme/language/model
in its session cookie. Reads validate against the allowed sets and fall back to
